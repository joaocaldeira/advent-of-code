...
for i in range(271973, 785961):
    ...
    if (list_digits[0] == list_digits[1] or list_digits[1] == list_digits[2] or list_digits[2] == list_digits[3] or
        list_digits[3] == list_digits[4] or list_digits[4] == list_digits[5]):
